...
from bin.pycocotools.coco import COCO
import math
...
class DataIterator():
    ...
    def __init__(self, path, resize, max_size, batch_size, shuffle, stride, world, annotations, training=False,
        ...
        self.shuffle = shuffle if world == 1 else False
        self.sampler = data.distributed.DistributedSampler(self.dataset) if world > 1 else None
        self.dataloader = data.DataLoader(self.dataset, batch_size=batch_size // world, shuffle=self.shuffle,
